...
@Testcontainers
class DataDetailIntegrationTest {
	...
	void setUp() {
		...
		restTemplate.exchange(API_DATA_MASTER_PATH, HttpMethod.POST, new HttpEntity<>(newRecord, headers),
				DataMasterDTO.class);
	...
	void shouldGetAllDetails() {
		// given
		String API_DATA_MASTER_PATH = "/api/data-details";
		HttpHeaders headers = createHeaders();
