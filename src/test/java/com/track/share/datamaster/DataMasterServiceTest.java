...
public class DataMasterServiceTest {
	...
	void shouldReturnAllMasterRecords_whenGetMasterRecordsIsCalled() {
		...
		DataMasterDTO dataMasterDTO = new DataMasterDTO(1, 1, "secret", "user123", "192.168.1.1", true,
				LocalDateTime.now(), LocalDateTime.now(), RequestType.PULL);
	...
	void shouldAddMasterRecordAndReturnDTO_whenAddMasterRecordIsCalled() {
		// Given
		DataMasterDTO masterDTO = new DataMasterDTO(null, 1, "secret", null, null, true, LocalDateTime.now(), null,
				RequestType.PULL);
		DataMaster dataMaster = new DataMaster();
		...
		when(userService.getUser("username"))
				.thenReturn(Users.builder().userId(1L).name("user").email("user@gmail.com").build());
	...
	void shouldUpdateMasterRecordAndReturnDTO_whenUpdateMasterRecordIsCalled() {
		// Given
		DataMasterDTO masterDTO = new DataMasterDTO(null, 1, "secret", "user123", "192.168.1.1", true,
				LocalDateTime.now(), null, RequestType.PULL);
